...
;
const metadata = {
    title: "SmartRecycle Coach - Recicla Correctamente con IA",
    description: "Identifica materiales reciclables con inteligencia artificial y aprende cómo reciclar correctamente. Tu coach personal de reciclaje.",
    generator: "v0.app",
    icons: {
        icon: [
            {
